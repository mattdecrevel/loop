...
export type LoopEvent =
  ...
  | (LoopEventBase & { type: 'booking'; payload: { name: string; email: string; start: string; notes?: string; startIso?: string; endIso?: string; location?: string; durationMin?: number; manageUrl?: string } })
